...
for arch_type in lenet5 alexnet
do
	for dataset in fashionmnist cifar10
	do
		for percent in 0.3 0.5 0.8
		do
			for kl in 1e-5 1e-6
			do
		    	for prior in -4 -2 
		    	do
			    	python3 -u prune_clean.py --lr 1e-3 --momentum 0.9 --weight_decay 1e-4 --lr_p 1e-2 --prune_type="noise"  --noise_type="bernoulli" \
		    	...
		    	# python3 -u prune_clean.py --lr 1e-3  --momentum 0.9 --weight_decay 1e-4 --lr_p 1e-2 --prune_type="noise"  --noise_type="gaussian" \
		    	#  --end_iter=100 --arch_type $arch_type   --noise_step=50 --prune_percent $percent \
		    ...
		    python3 -u prune_clean.py --lr 1e-3 --momentum 0.9 --weight_decay 1e-4 --prune_type="lt" \
