        ...
        for iter_ in pbar:
            ...
            if iter_ % args.print_freq == 0:
                pbar.set_description(
                    f'Train Epoch: {iter_}/{end_iter} Loss: {loss:.6f} Accuracy: {accuracy:.2f} {train_acc:.2f}% Best Accuracy: {best_accuracy:.2f}%')       

        print(f'Train Epoch: {iter_}/{end_iter} Loss: {loss:.6f} Accuracy: {accuracy:.2f} {train_acc:.2f}% Best Accuracy: {best_accuracy:.2f}%') 
